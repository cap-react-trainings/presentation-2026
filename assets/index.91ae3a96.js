...
`,Ce="const { loading, books } = useBooks()",Re=`const fetchUsers = async () => {
...
`,We=`const AddModal = lazy(() => import('./AddModal))
...
`,$e=`const Stack = createNativeStackNavigator();
...
`,it="yarn add -D @testing-library/react @testing-library/jest-dom jest jest-environment-jsdom",st="yarn add -D ts-jest @types/jest @types/testing-library__react @types/testing-library__jest-dom",at=`//jest.config.js
...
...`,ct=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{className:"fragment",children:tt})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{className:"fragment",children:rt})]}),t(r,{children:[e("h2",{children:"API Mocking with MSW"}),e("p",{children:'"Mock service worker"'}),e(n,{className:"fragment",children:nt}),e(n,{className:"fragment",children:ot})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})})]})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("code",{children:"git checkout 06-forms-chapter"}),e("p",{children:"Setup for testing"}),e(n,{language:"bash",children:it}),e(n,{language:"bash",children:st})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("p",{children:"Create / modify files"}),e(n,{language:"bash",children:at}),e(n,{language:"bash",children:lt})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const b=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const dt={plugins:[R],slideNumber:!0,history:!0},ht=o=>(p.exports.useEffect(()=>{new C(dt).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),ut=()=>{const o=[{title:"Comparison of Frameworks",component:J},{title:"JSX & TSX",component:Ie},{title:"Components & Styling",component:ie},{title:"Conditional Rendering",component:me},{title:"Hooks & Databinding",component:Te},{title:"Context",component:ke},{title:"Routing",component:j},{title:"Forms",component:Me},{title:"Testing",component:ct},{title:"Atomic Design & Storybook",component:et},{title:"Improving Performance",component:Ye},{title:"React Native",component:Ke}];return t(ht,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(b,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(b,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),t(r,{isMain:!0,children:[e("h2",{children:"About You"}),t("div",{style:{textAlign:"left",display:"inline-block"},children:["\u{1F64B}\u200D\u2640\uFE0F Who are you?",e("br",{}),"\u{1F3CB}\uFE0F\u200D\u2640\uFE0F What experience do you have with web development?",e("br",{}),"\u{1F4AD} What do you expect from the training?"]})]}),e(D,{chapter:o}),o.map((i,s)=>e(i.component,{title:i.title,index:s+1},s))]})};B.render(e(A.StrictMode,{children:e(ut,{})}),document.getElementById("root"));
