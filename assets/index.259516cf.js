...
]);`,_=`import { useLoaderData } from "react-router";

function MyRoute() {
  const { records } = useLoaderData<typeof loader>();
  return <div>{records.length}</div>;
}`,z=`import { useNavigate } from "react-router";
...
`,je="const { loading, books } = useBooks();",Oe=`const fetchUsers = async () => {
  const res = await fetch("https://jsonplaceholder.typicode.com/users");
  return res.json();
};
`,Ue=`import { useQuery } from "react-query";
...
remove,
status,
`,ze=`const {isLoading, data, error} = useQuery("books", fetchBooks);
...
`,mt=`const Stack = createNativeStackNavigator();
...
`,Ct="yarn add -D vitest jsdom",xt="yarn add -D @testing-library/react @testing-library/jest-dom @testing-library/user-event",Rt=`//src/test/setup-test
...
...`,At=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{children:bt})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{children:kt})]}),t(r,{children:[e("h2",{children:"API Mocking"}),e(n,{children:vt})]}),e(r,{children:e(n,{children:wt})}),t(r,{children:[e("h2",{children:"Simulate actions"}),e(n,{className:"fragment",children:Nt})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})}),e("li",{children:e("a",{href:"https://vitest.dev/guide/mocking",target:"_blank",rel:"noreferrer",children:"Mocking with vitest"})})]})]}),t(r,{children:[e("p",{children:"Usual setup for testing:"}),e(n,{language:"bash",children:Ct}),e(n,{language:"bash",children:xt})]}),t(r,{children:[e(n,{language:"bash",children:Rt}),e(n,{language:"bash",children:St})]}),e(r,{children:e(n,{language:"bash",children:Bt})}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("code",{children:"git checkout 07-initial-testing-setup"})]}),t(r,{children:[t("div",{style:{display:"flex",justifyContent:"center",gap:24},children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("small",{children:"\u23F1\uFE0F 55min"})]}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const k=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const Ft={plugins:[A],slideNumber:!0,history:!0},Pt=o=>(m.exports.useEffect(()=>{new B(Ft).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),Tt=()=>{const o=[{title:"Comparison of Frameworks",component:K},{title:"React in a nutshell \u{1F95C}",component:tt},{title:"Components & Styling",component:be},{title:"Conditional Rendering",component:Se},{title:"Hooks & Databinding",component:We},{title:"Context",component:Me},{title:"Routing",component:V},{title:"Forms",component:Qe},{title:"Testing",component:At},{title:"Atomic Design & Storybook",component:yt},{title:"Improving Performance",component:ut},{title:"React Native",component:gt}];return t(Pt,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(k,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(k,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),e(q,{chapter:o}),o.map((i,a)=>e(i.component,{title:i.title,index:a+1},a)),t(r,{isMain:!0,children:[e("h2",{children:"Thanks a lot!"}),e("p",{children:"Please fill out our survey, so that we can keep on improving! \u{1F60A}"})]})]})};F.render(e(P.StrictMode,{children:e(Tt,{})}),document.getElementById("root"));
