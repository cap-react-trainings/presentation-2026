var w=Object.defineProperty,C=Object.defineProperties;var N=Object.getOwnPropertyDescriptors;var g=Object.getOwnPropertySymbols;var x=Object.prototype.hasOwnProperty,R=Object.prototype.propertyIsEnumerable;var f=(o,i,a)=>i in o?w(o,i,{enumerable:!0,configurable:!0,writable:!0,value:a}):o[i]=a,l=(o,i)=>{for(var a in i||(i={}))x.call(i,a)&&f(o,a,i[a]);if(g)for(var a of g(i))R.call(i,a)&&f(o,a,i[a]);return o},c=(o,i)=>C(o,N(i));import{j as v,r as m,P as S,$ as A,S as B,R as F,a as P}from"./vendor.dc908a88.js";const M=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))u(s);new MutationObserver(s=>{for(const h of s)if(h.type==="childList")for(const p of h.addedNodes)p.tagName==="LINK"&&p.rel==="modulepreload"&&u(p)}).observe(document,{childList:!0,subtree:!0});function a(s){const h={};return s.integrity&&(h.integrity=s.integrity),s.referrerpolicy&&(h.referrerPolicy=s.referrerpolicy),s.crossorigin==="use-credentials"?h.credentials="include":s.crossorigin==="anonymous"?h.credentials="omit":h.credentials="same-origin",h}function u(s){if(s.ep)return;s.ep=!0;const h=a(s);fetch(s.href,h)}};M();const e=v.exports.jsx,t=v.exports.jsxs,r=o=>e("section",c(l({"data-background-image":o.isMain?"/presentation-2026//bg1.svg":void 0,"data-background-transition":o.isMain?"slide":void 0,style:o.isMain?{"--r-heading-color":"white",color:"white"}:{},"data-auto-animate":o.dataAutoAnimate,id:o.id||""},o),{children:o.children})),d=o=>{const i=`${o.index}. ${o.title}`;return t(r,{id:"chapter"+o.index,children:[e("div",{style:{position:"absolute",bottom:0,left:0,color:"#0070ad",opacity:.5,fontSize:"1rem"},children:i}),t(r,{isMain:!0,children:[e("h2",{children:i}),o.subtitle]}),o.children]})};const n=o=>{const i=m.exports.useRef(null);return m.exports.useEffect(()=>{setTimeout(()=>{i.current&&S.highlightElement(i.current,!1,a=>console.log(a))},0)},[o.children]),e("pre",{className:o.className,"data-line":o.highlightedLines||"",children:e("code",{ref:i,className:`language-${o.language||"tsx"} line-numbers`,children:o.children})})},T=`import * as React from "react";
...
]);`,H='<Link to="/homepage">Go to Homepage</Link>',D=`import { NavLink } from "react-router-dom";
...
>Messages</NavLink>`,I=`function Dashboard() {
  return (
    <div>
      <h1>Dashboard</h1>
...
}`,_=`import { useNavigate } from "react-router";
...
<MyButton title='Hit me' /> // ok`,ue="$ npx create-react-app my-app --template typescript",pe="$ npm create vite@latest my-app -- --template react-ts",me="type PropsWithChildren<P> = P & { children?: ReactNode };",ge=`import { PropsWithChildren } from 'react';
...
}`,Ce=`const AuthenticationComponent = (props: Props) => {
  let button;
  if (props.userName) {
    button = <LogoutButton />
  } else {
...
`,Ne=`const UsersList = (props: Props) => {
...
`,Me=`const {theme, toggleTheme} = useContext(UserContext)
...
`,De=`const [books, setBooks] = useState<Book>();
...
`,Ie=`const [currentBooks, setCurrentBooks] = useState<Book[]>();
...
`,ze="const { loading, books } = useBooks();",Ue=`const fetchUsers = async () => {
...
`,Ke=`npx create-react-app my-app
# or better
...
npm install
npm start
`,Ze="const element = <h1>Welcome to React!</h1>",et=`export default MyButton = () => {
    return <button>Click Me!</button>
}`,tt=`import MyButton from './myButton';
<MyButton /> // ok
...
`,rt=`const element = {
  ...
  `,nt=o=>t(d,c(l({},o),{subtitle:e("p",{children:"Minimal App, Bootstrapping & Templating"}),children:[t(r,{children:[e("h2",{children:"Minimal App"}),e(n,{className:"fragment",children:$e})]}),t(r,{children:[e("h2",{children:"Bootstrapping a Project"}),e(n,{className:"fragment",language:"bash",children:Ke})]}),t(r,{children:[e("h2",{children:"Templating with JSX / TSX"}),e("p",{className:"fragment",children:"syntax extension to JavaScript"}),e("p",{className:"fragment",children:"describe what the UI looks like"}),e("p",{className:"fragment",children:"full power of JavaScript"}),e("p",{className:"fragment",children:"produces React elements"}),e("p",{className:"fragment",children:"TSX enhances JSX in terms of type checking"}),e(n,{className:"fragment",children:Ze})]}),t(r,{children:[e("h2",{children:"JSX / TSX Elements"}),t("ul",{className:"fragment",children:[e("li",{children:"elements are looked up by identifiers"}),e("li",{children:"naming convention starts with capital letter"}),e("li",{children:"You can import them as a component in your app"})]}),e(n,{className:"fragment",children:et}),e(n,{className:"fragment",children:tt})]}),t(r,{children:[e("h2",{children:"JavaScript in Elements"}),e(n,{children:rt}),e("p",{children:"notice the following:"}),t("ul",{children:[t("li",{children:["JSX Elements can have mutlitple children but need ",e("b",{children:"one"})," root element"]}),t("li",{children:["empty tags may be closed immediatly with `","/>","`"]}),t("li",{children:["JavaScript can be used inside JSX (","{}",")"]})]})]}),t(r,{children:[e("h2",{children:"Minimal App with data"}),e(n,{children:Xe})]})]})),ot="<AddButton onClick={() => setIsAddOpen(true)} />",it=`const moizedOpen = useCallback(() => {
    setIsAddOpen(true);
...
})`,st=`export const AddButton = React.memo(
  function AddButton({ onClick, books[] }) {
    return (
        <button onClick={onClick}>Add {books.length} books</button>
    )
}, (p1, p2) => p1.books.length === p2.books.length);`,lt=`const [books, setBooks] = useState(props.books);
const moizedBook = useMemo(() => {
  return books.find(book => book.author === props.author);
}, [books, props.author]);
`,ct=`const AddModal = lazy(() => import('./AddModal))
...
`,dt=`const About = React.lazy(() => import("./pages/About"));
...
`,ft=`const Stack = createNativeStackNavigator();
...
`,Rt="yarn add -D vitest jsdom",St="yarn add -D @testing-library/react @testing-library/jest-dom @testing-library/user-event",At=`//src/test/setup-test
...
...`,Pt=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{children:vt})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{children:wt})]}),t(r,{children:[e("h2",{children:"API Mocking"}),e(n,{children:Ct})]}),e(r,{children:e(n,{children:Nt})}),t(r,{children:[e("h2",{children:"Simulate actions"}),e(n,{className:"fragment",children:xt})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})}),e("li",{children:e("a",{href:"https://vitest.dev/guide/mocking",target:"_blank",rel:"noreferrer",children:"Mocking with vitest"})})]})]}),t(r,{children:[e("p",{children:"Usual setup for testing:"}),e(n,{language:"bash",children:Rt}),e(n,{language:"bash",children:St})]}),t(r,{children:[e(n,{language:"bash",children:At}),e(n,{language:"bash",children:Bt})]}),e(r,{children:e(n,{language:"bash",children:Ft})}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("code",{children:"git checkout 07-initial-testing-setup"})]}),t(r,{children:[t("div",{style:{display:"flex",justifyContent:"center",gap:24},children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("small",{children:"\u23F1\uFE0F 55min"})]}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const k=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const Mt={plugins:[B],slideNumber:!0,history:!0},Tt=o=>(m.exports.useEffect(()=>{new A(Mt).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),Lt=`// Traditional monolithic React app
src/
  components/
    Header/
    ProductList/
...
`,Dt=`// vite.config.ts - Product Catalog App
import { defineConfig } from 'vite';
import { federation } from '@originjs/vite-plugin-federation';
...
`,It=`// Shell App - Lazy loading microfrontends
...
`,jt=`// Shared dependencies configuration
{
  shared: {
...
`,Ot=o=>t(d,c(l({},o),{subtitle:e("blockquote",{children:'"Microfrontends enable teams to work independently on different parts of a frontend application while maintaining a unified user experience."'}),children:[e(r,{children:e("img",{style:{width:800,margin:"auto"},src:"./slide-assets/microfrontends.jpg"})}),t(r,{children:[e("h2",{children:"When to use?"}),t("ul",{className:"fragment",children:[e("li",{children:"Large teams working on different features"}),e("li",{children:"Independent deployment cycles"}),e("li",{children:"Technology diversity needs"}),e("li",{children:"Organizational autonomy"})]}),e("aside",{className:"notes",children:"Microfrontends are great for scaling teams and enabling independent development cycles."})]}),t(r,{children:[e("h2",{children:"\u{1F575}\uFE0F Be careful!"}),e("p",{className:"fragment",children:"Increased complexity in development setup"}),e("p",{className:"fragment",children:"Runtime overhead from module federation"}),e("p",{className:"fragment",children:"Shared dependency version conflicts"}),e("p",{className:"fragment",children:"Only use for medium to large applications"}),e("aside",{className:"notes",children:"Don't over-engineer small applications. The complexity overhead might not be worth it."})]}),t(r,{children:[e("h2",{children:"From Monolith"}),e(n,{children:Lt})]}),t(r,{children:[e("h2",{children:"To Microfrontends"}),e(n,{children:Et})]}),t(r,{children:[e("h2",{children:"Vite Configuration - Shell"}),e(n,{highlightedLines:"6-11",children:Ht})]}),t(r,{children:[e("h2",{children:"Vite Configuration - Remote"}),e(n,{highlightedLines:"8-12",children:Dt})]}),t(r,{children:[e("h2",{children:"Lazy Loading Components"}),e(n,{highlightedLines:"3-4|8-13",children:It})]}),t(r,{children:[e("h2",{children:"Shared Dependencies"}),e(n,{children:jt}),e("aside",{className:"notes",children:"Singleton ensures only one instance is loaded. Non-singleton allows multiple versions."})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://vitejs.dev/guide/build.html#library-mode",target:"_blank",rel:"noreferrer",children:"Vite Module Federation"})}),e("li",{children:e("a",{href:"https://micro-frontends.org/",target:"_blank",rel:"noreferrer",children:"\u{1F680} Microfrontends.org"})}),e("li",{children:e("a",{href:"https://martinfowler.com/articles/micro-frontends.html",target:"_blank",rel:"noreferrer",children:"\u{1F680} Martin Fowler's Microfrontends"})})]}),e("aside",{className:"notes",children:"Great resources to dive deeper into microfrontend patterns and best practices."})]})]})),zt=()=>{const o=[{title:"Comparison of Frameworks",component:K},{title:"React in a nutshell \u{1F95C}",component:nt},{title:"Components & Styling",component:be},{title:"Conditional Rendering",component:Se},{title:"Hooks & Databinding",component:Ve},{title:"Context",component:Ee},{title:"Routing",component:V},{title:"Microfrontends",component:Ot},{title:"Forms",component:Ye},{title:"Testing",component:Pt},{title:"Atomic Design & Storybook",component:kt},{title:"Improving Performance",component:mt},{title:"React Native",component:yt}];return t(Tt,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(k,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(k,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),e(q,{chapter:o}),o.map((i,a)=>e(i.component,{title:i.title,index:a+1},a)),t(r,{isMain:!0,children:[e("h2",{children:"Thanks a lot!"}),e("p",{children:"Please fill out our survey, so that we can keep on improving! \u{1F60A}"})]})]})};F.render(e(P.StrictMode,{children:e(zt,{})}),document.getElementById("root"));
