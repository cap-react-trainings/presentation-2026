...
`,j=o=>t(d,c(l({},o),{subtitle:e("blockquote",{children:'"Routing is the base for making a react application capable of showing multiple screens or components with a history and URL "'}),children:[t(r,{children:[e("h2",{children:"What types do we have?"}),t("ul",{className:"fragment",children:[e("li",{children:"Browser Routing (Basic Routing)"}),e("li",{children:"Hashrouting"})]}),e("p",{className:"fragment",children:"Consider using Browser Routing most of the time. Hashrouting only if Browser Routing is encoded (Mircofrontend)."})]}),t(r,{children:[e("h2",{children:"Browser Routing"}),e("p",{children:"Needed imports:"}),e(n,{children:T})]}),t(r,{children:[e("p",{children:"Navigation Bar:"}),e(n,{children:L})]}),t(r,{children:[e("p",{children:"Defined Routes:"}),e(n,{children:H})]}),t(r,{children:[e("h2",{children:"Retrieve Parameters"}),e(n,{children:M})]}),t(r,{children:[e("h2",{children:"Hash Routing"}),e("p",{children:"basically the same as Browser Routing just another import and the URL will look like this:"}),e("p",{children:"...yoururl.de/#/path"}),e(n,{children:E})]}),t(r,{children:[e("p",{children:"Special cases:"}),t("ul",{children:[e("li",{className:"fragment",children:"the / will sometimes be converted to a %2F"}),e("li",{className:"fragment",children:"some browser do not understand the hashrouting"}),e("li",{className:"fragment",children:"it is not a 'real' routing"})]})]}),t(r,{children:[e("h2",{children:"Guards"}),e("p",{className:"fragment",children:"One special, but important part."}),e("p",{className:"fragment",children:"Guards are for securing routes."}),e("p",{className:"fragment",children:"Whether you are allowed to ENTER or"}),e("p",{className:"fragment",children:"to LEAVE the page"})]}),t(r,{children:[e("p",{children:"Browser Router"}),e(n,{className:"fragment",children:P})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactrouter.com/en/main/start/tutorial#setup",target:"_blank",rel:"noreferrer",children:"React Router"})}),e("li",{children:e("a",{href:"https://reactrouter.com/en/main/hooks/use-params",target:"_blank",rel:"noreferrer",children:"Hooks"})})]})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[t("li",{children:["Use"," ",e("a",{href:"https://reactrouter.com/en/main",target:"_blank",rel:"noreferrer",children:"React Router"})," ","to implement a routing to the detail page of a book (in App.tsx)"]}),e("li",{children:"Clicking on the title of a book in the list should forward the user to the detail page (/detail/[isbn])"}),e("li",{children:"On the detail page, a request is triggered to get the book details (https://api.itbook.store/1.0/books/[isbn])"}),e("li",{children:"The book details are displayed on this page"})]})]})]})),D=o=>t(r,{isMain:!0,children:[e("h2",{children:"Table of Contents"}),e("ol",{children:o.chapter.map((i,s)=>e("li",{children:e("a",{href:`#/chapter${s+1}`,style:{color:"white"},children:i.title})},s))})]}),I=()=>e("svg",{version:"1.1",id:"Capa_1",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",x:"0px",y:"0px",viewBox:"0 0 490 490",width:40,height:40,children:e("g",{children:e("path",{d:"M52.8,311.3c-12.8-12.8-12.8-33.4,0-46.2c6.4-6.4,14.7-9.6,23.1-9.6s16.7,3.2,23.1,9.6l113.4,113.4V32.7 c0-18,14.6-32.7,32.7-32.7c18,0,32.7,14.6,32.7,32.7v345.8L391,265.1c12.8-12.8,33.4-12.8,46.2,0c12.8,12.8,12.8,33.4,0,46.2 L268.1,480.4c-6.1,6.1-14.4,9.6-23.1,9.6c-8.7,0-17-3.4-23.1-9.6L52.8,311.3z",fill:"white"})})}),_=`<ul>
...
`,ie=`export default LoginButton: React.FC = () => {
    return <button>Login</button>
}`,se=`export default LogoutButton: React.FC = () => {
    return <button>Logout</button>
}`,ae=`const AuthenticationComponent: React.FC = (props: Props) => {
  let button;
  if (props.userName) {
    button = <LogoutButton />
  } else {
...
`,le=`const UsersList: React.FC = (props: Props) => {
...
`,ce=`const UsersList: React.FC = (props: Props) => {
  const users = props.users
  return (
    <div>
      <h2>My fancy app</h2>
...
}`,he=o=>t(d,c(l({},o),{subtitle:t("ul",{children:[e("li",{children:"rendering different components"}),e("li",{children:"inline conditions"})]}),children:[t(r,{children:[e("h2",{children:"Component uses different return statements"}),e(n,{className:"fragment",children:oe})]}),t(r,{children:[e("h2",{children:"Conditionally assign component to variable"}),t("div",{className:"fragment",children:[e(n,{className:"",children:ie}),e(n,{className:"",children:se})]}),e(n,{className:"fragment",children:ae})]}),t(r,{children:[e("h2",{children:"Inline Logic - variant 1"}),e(n,{className:"fragment",children:le})]}),t(r,{children:[e("h2",{children:"Inline Logic - variant 2"}),e(n,{className:"fragment",children:ce})]}),t(r,{children:[e("h2",{children:"Prevent component from rendering"}),e(n,{className:"fragment",children:de})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Extend your Book-Component with a badge that notifies the user when a book is not available in store. (Pass an additional prop to your Book-Component)."}),e("li",{children:"Bear in mind that there might be a case where no books are available for rendering. Create a UI for that."})]})]})]})),ue=`// fetch user...
...
`,me=`const UserContext = React.createContext<User>(null);
...
`,pe=`const user = useContext(UserContext);

<Link href={user.permalink}>
  <Avatar user={user} />
</Link>
`,ge=`export const ThemeContext = React.createContext({
  theme: themes.dark,
  toggleTheme: () => {},
});
`,fe=`const {theme, toggleTheme} = useContext(UserContext)
...
`,ke=`const [books, setBooks] = useState<Book>()
...
`,ve=`const [currentBooks, setCurrentBooks] = useState<Book[]>()
...
`,xe="const { loading, books } = useBooks()",Se=`const fetchUsers = async () => {
  const res = await fetch("https://jsonplaceholder.typicode.com/users");
  return res.json();
};
`,Re=`import { useQuery } from "react-query";
...
remove,
status,
`,Be=`const {loading, data, error} = useQuery("books", fetchBooks);
...
`,Ae=o=>t(d,c(l({},o),{subtitle:t("ul",{children:[e("li",{children:"Hooks"}),e("li",{children:"Databinding"}),e("li",{children:"Databinding and Hooks: influence the component's rendering"}),e("li",{children:"Custom Hooks"}),e("li",{children:"useQuery-Hook"})]}),children:[t(r,{children:[e("h2",{children:"Hooks"}),e("p",{children:"work with React state and lifecycle features from function components"}),e("p",{children:"No more need for Class Components \u{1F601}"}),e("p",{children:"most important React Hooks: useState, useEffect, (useContext, useReducer, useCallback, useMemo, ...)"})]}),t(r,{children:[e("h2",{children:"useState-Hook"}),t("ul",{children:[e("li",{className:"fragment",children:"add state management to function components"}),e("li",{className:"fragment",children:"component rerenders when state in hook changes"}),e("li",{className:"fragment",children:"syntax: array destructuring"}),t("ul",{children:[e("li",{className:"fragment",children:"first value is set to the state value"}),e("li",{className:"fragment",children:"second value is used to update the value"})]})]})]}),t(r,{children:[e("h2",{children:"useState-Hook"}),e(n,{children:ye}),e("pre",{className:"fragment",children:e("a",{style:{fontSize:"1.7rem",marginTop:4},target:"_blank",rel:"noreferrer",href:"https://github.com/cap-react-trainings/code-examples/blob/03-hooks-usestate/react-training-codeexamples/src/App.tsx",children:"\u{1F680} code example on GitHub"})})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Implement some buttons, that determine how many books should be rendered inside your book-list."}),e("li",{children:"As you might have already guessed: the useState-hook is your friend!"})]})]}),t(r,{children:[e("h2",{children:"useEffect-Hook"}),t("ul",{children:[e("li",{className:"fragment",children:"perform side effects in components"}),e("li",{className:"fragment",children:"e.g. for data fetching"}),e("li",{className:"fragment",children:"cleanup when a component's lifecycle is over"}),e("li",{className:"fragment",children:"define when to run it with the dependency array"})]})]}),t(r,{children:[e("h2",{children:"useEffect-Hook: Data Fetching"}),e(n,{className:"fragment",children:ke}),e("pre",{className:"fragment",children:e("a",{style:{fontSize:"1.7rem",marginTop:4},target:"_blank",rel:"noreferrer",href:"https://github.com/cap-react-trainings/code-examples/blob/03-hooks-useeffect/react-training-codeexamples/src/App.tsx",children:"\u{1F680} code example on GitHub"})})]}),t(r,{children:[e("h2",{children:"useEffect-Hook: Dependency Array"}),e(n,{className:"fragment",highlightedLines:"8",children:ve})]}),t(r,{children:[e("h2",{children:"useEffect-Hook: Unmount of Component"}),e(n,{className:"fragment",children:we})]}),t(r,{children:[e("h2",{children:"Rules of Hooks"}),t("ul",{children:[e("li",{className:"fragment",children:"only call Hooks at the top level of a component. React will run into problems when calling hooks after determining conditions"}),e("li",{className:"fragment",children:"Don't call Hooks from regular JS functions, the only other valid place are custom Hooks"})]})]}),t(r,{children:[e("h2",{children:"Custom Hooks"}),e("ul",{children:e("li",{className:"fragment",children:"extract component logic into reusable functions"})}),e(n,{className:"fragment",children:Ne}),e(n,{className:"fragment",children:xe})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[t("li",{children:["As of now: we'd like to get rid of our dummy book-data and use an"," ",e("a",{href:"https://api.itbook.store/1.0/new",target:"_blank",rel:"noreferrer",children:"API"})," ","instead."]}),e("li",{children:"Fetch the books to display from the API."}),e("li",{children:`Update your conditional rendering in Book.tsx: Place a badge "cheap" when the book's price is less than 30$, else the badge should display "expensive".`}),e("li",{children:"Since data fetching takes some time, also provide a loading spinner that tells the user you are fetching data while there are no books to display yet."}),t("li",{children:["Brownie points: In case you're finished early: learn about the"," ",e("a",{href:"https://tanstack.com/query/v4/docs/reference/useQuery?from=reactQueryV3&original=https://react-query-v3.tanstack.com/reference/useQuery",children:"useQuery-Hook"}),", do some refactoring and implement your datafetching by using useQuery."]})]})]}),t(r,{children:[e("h2",{children:"Excursus: useQuery (React Query)"}),t("ul",{children:[e("li",{className:"fragment",children:"data-fetching library for React"}),e("li",{className:"fragment",children:"fetching, caching, synchronizing and updating server state in React applications"}),e("li",{className:"fragment",children:"useQuery-Hook: handle various states in the fetching process, e.g. loading, error, data, ..."}),e("li",{className:"fragment",children:"React Query provides further Hooks"})]})]}),t(r,{children:[e("h2",{children:"Excursus: useQuery (React Query)"}),e(n,{className:"fragment",children:Se}),e(n,{className:"fragment",children:Re})]}),t(r,{children:[e("h2",{children:"Excursus: useQuery (React Query)"}),e("p",{children:"Response Object"}),e(n,{className:"fragment",children:Ce})]}),t(r,{children:[e("h2",{children:"Excursus: useQuery (React Query)"}),e("p",{children:"save code, no need to handle states by yourself"}),e(n,{className:"fragment",children:Be}),e("pre",{className:"fragment",children:e("a",{style:{fontSize:"1.7rem",marginTop:4},target:"_blank",rel:"noreferrer",href:"https://github.com/cap-react-trainings/code-examples/blob/03-hooks-use-query-with-material/react-training-codeexamples/src/components/book-list/BookList.tsx",children:"\u{1F680} code example on GitHub"})})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Homework"}),e("ul",{children:e("li",{children:"If not done yet: refactor your code and implement the data fetching part by using the useQuery-Hook."})})]}),t(r,{children:[e("h2",{children:"Angular Excursus: Observable vs State"}),e("p",{className:"fragment",children:"When coming from Angular it is often asked what happened to the Observables"}),e("p",{className:"fragment",children:"You just simply don't need them :) The state listening in a useEffect for example is like a simple pipe in Angular"}),e("p",{className:"fragment",children:'However it is possible to have "real" subscribe with mobx for example.'})]})]})),Fe=`<Formik
...
`,Te=`const { register, handleSubmit, errors } = useForm<MyForm>();
...
`,Pe=`const element = (
  ...
  `,je=o=>t(d,c(l({},o),{subtitle:e("p",{children:"Templating with JavaScript"}),children:[t(r,{children:[e("h2",{children:"JSX / TSX"}),e("p",{className:"fragment",children:"syntax extension to JavaScript"}),e("p",{className:"fragment",children:"describe what the UI looks like"}),e("p",{className:"fragment",children:"full power of JavaScript"}),e("p",{className:"fragment",children:"produces React elements"}),e("p",{className:"fragment",children:"TSX enhances JSX in terms of type checking"}),e(n,{className:"fragment",children:He})]}),t(r,{children:[e("h2",{children:"JSX / TSX Elements"}),t("ul",{className:"fragment",children:[e("li",{children:"elements are looked up by identifiers"}),e("li",{children:"naming convention starts with capital letter"}),e("li",{children:"You can import them as a component in your app"})]}),e(n,{className:"fragment",children:Me}),e(n,{className:"fragment",children:Ee})]}),t(r,{children:[e("h2",{children:"JavaScript in Elements"}),e(n,{children:Pe}),e("p",{children:"notice the following:"}),t("ul",{children:[t("li",{children:["JSX Elements can have mutlitple children but need ",e("b",{children:"one"})," root element"]}),t("li",{children:["empty tags may be closed immediatly with `","/>","`"]}),t("li",{children:["JavaScript can be used inside JSX (","{}",")"]})]})]})]})),De="<AddButton onClick={() => setIsAddOpen(true)} />",Ie=`const moizedOpen = useCallback(() => {
    setIsAddOpen(true);
}, []);`,_e=`export const AddButton = React.memo(
  function AddButton({ onClick }) {
    return (
        <button onClick={onClick}>Add</button>
    )
})`,Oe=`export const AddButton = React.memo(
  function AddButton({ onClick, books[] }) {
    return (
        <button onClick={onClick}>Add {books.length} books</button>
    )
}, (p1, p2) => p1.books.length === p2.books.length);`,Ue=`const [books, setBooks] = useState(props.books);
const moizedBook = useMemo(() => {
  return books.find(book => book.author === props.author);
}, [books, props.author]);
`,ze=`const AddModal = lazy(() => import('./AddModal))
...
`,Je=`const About = React.lazy(() => import("./pages/About"));
export default function App() {
  return (
    <Routes>
...
`,Ye=`const Stack = createNativeStackNavigator();
...
`,nt="yarn add -D @testing-library/react @testing-library/jest-dom jest jest-environment-jsdom",ot="yarn add -D ts-jest @types/jest @types/testing-library__react @types/testing-library__jest-dom",it=`//jest.config.js
...
...`,at=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{className:"fragment",children:Ze})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{className:"fragment",children:et})]}),t(r,{children:[e("h2",{children:"API Mocking with MSW"}),e("p",{children:'"Mock service worker"'}),e(n,{className:"fragment",children:tt}),e(n,{className:"fragment",children:rt})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})})]})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("p",{children:"Setup for testing"}),e(n,{language:"bash",children:nt}),e(n,{language:"bash",children:ot})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("p",{children:"Create / modify files"}),e(n,{language:"bash",children:it}),e(n,{language:"bash",children:st})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const b=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const lt={plugins:[C],slideNumber:!0,history:!0},ct=o=>(p.exports.useEffect(()=>{new R(lt).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),dt=()=>{const o=[{title:"Comparison of Frameworks",component:J},{title:"JSX & TSX",component:je},{title:"Components & Styling",component:ne},{title:"Conditional Rendering",component:he},{title:"Hooks & Databinding",component:Ae},{title:"Context",component:be},{title:"Routing",component:j},{title:"Forms",component:Le},{title:"Testing",component:at},{title:"Atomic Design & Storybook",component:Ke},{title:"Improving Performance",component:Ve},{title:"React Native",component:Xe}];return t(ct,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(b,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(b,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),t(r,{isMain:!0,children:[e("h2",{children:"About You"}),t("div",{style:{textAlign:"left",display:"inline-block"},children:["\u{1F64B}\u200D\u2640\uFE0F Who are you?",e("br",{}),"\u{1F3CB}\uFE0F\u200D\u2640\uFE0F What experience do you have with web development?",e("br",{}),"\u{1F4AD} What do you expect from the training?"]})]}),e(D,{chapter:o}),o.map((i,s)=>e(i.component,{title:i.title,index:s+1},s))]})};B.render(e(A.StrictMode,{children:e(dt,{})}),document.getElementById("root"));
