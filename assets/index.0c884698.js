...
`,se=o=>t(d,c(l({},o),{subtitle:e("p",{children:"JavaScript functions, accept Props and return React Elements (JSX)"}),children:[t(n,{children:[e("h2",{children:"Class Components vs. Functional Components"}),e(r,{className:"fragment",children:Y}),e(r,{className:"fragment",children:X}),e("p",{className:"fragment",children:"same output"})]}),t(n,{children:[e("h2",{children:"Class Components vs. Functional Components"}),e("p",{className:"fragment",children:"Whats the difference? When should I use which one?"}),t("ul",{className:"fragment",children:[e("li",{children:"historical reasons: no state-management / lifecycle hooks before 2019 in functional components"}),e("li",{children:"nowadays: hardly any usage of class components"}),e("li",{children:"functional components are easier to read and test, less code, better performance"})]}),e("a",{href:"https://www.twilio.com/blog/react-choose-functional-components",target:"_blank",className:"fragment",rel:"noreferrer",children:"\u{1F680} understanding functional components vs class components"})]}),t(n,{children:[e("h2",{children:"Properties (aka Props)"}),e("p",{children:"Pass information down the component tree"}),e(r,{className:"fragment",children:oe}),e(r,{className:"fragment",children:ie}),e("aside",{className:"notes",children:"Or use any other way of passing JS objects (e.g. destructuring)."})]}),t(n,{children:[e("h2",{children:"Properties (aka Props)"}),e("p",{className:"fragment",children:"Book-List which renders various Books from a Book component"}),e("p",{className:"fragment",children:"The Book component doesn't 'know' what to render so we need to pass the information"})]}),t(n,{children:[e("h2",{children:"Properties (aka Props)"}),e(r,{highlightedLines:"10",children:$}),e("pre",{children:e("a",{style:{fontSize:"1.7rem",marginTop:4},href:"https://github.com/cap-react-trainings/code-examples/blob/03-conditional-rendering-basic/react-training-codeexamples/src/App.tsx",children:"\u{1F680} code example on GitHub"})}),e("aside",{className:"notes",children:"map: this is how we iterate over arrays in React (angular ngFor, vue: v-for)"})]}),t(n,{children:[e("h2",{children:"Properties: not destructured"}),e(r,{className:"fragment",highlightedLines:"7",children:K})]}),t(n,{children:[e("h2",{children:"Properties: destructured"}),e(r,{className:"fragment",highlightedLines:"7",children:_})]}),t(n,{children:[e("h2",{children:"Properties: destructured vs not destructured"}),t("ul",{children:[t("li",{className:"fragment",children:["Pro: easier to apply default values",e(r,{highlightedLines:"1",children:Z})]}),e("li",{className:"fragment",children:"Con: in case of large components you might get confused which variables are defined in the component scope and which ones are passed as props"})]})]}),t(n,{children:[e("h2",{children:"Let's style our Booklist"}),t("ul",{className:"fragment",children:[e("li",{children:"via css classes"}),e("li",{children:"via inline styling"}),e("li",{children:"CSS in JS"})]})]}),t(n,{children:[e("h2",{children:"className"}),e("p",{className:"fragment",children:"instead of using the 'class'-attribute, React expects 'className'"}),e(r,{className:"fragment",children:ee})]}),t(n,{children:[e("h2",{children:"Inline Styling"}),e("p",{className:"fragment",children:"inline styling is also possible via the well known 'style'-attribute"}),e("p",{className:"fragment",children:"notice the double curly braces, usual CSS-syntax inside"}),e(r,{className:"fragment",children:te}),e("pre",{className:"fragment",children:e("a",{style:{fontSize:"1.7rem",marginTop:4},href:"https://github.com/cap-react-trainings/code-examples/blob/02-conditional-rendering-basic/react-training-codeexamples/src/components/book/Book.tsx",children:"\u{1F680} code example on GitHub"})})]}),t(n,{children:[e("h2",{children:"CSS in JS"}),t("ul",{className:"fragment",children:[e("li",{children:"Style components using JavsScript"}),e("li",{children:"JavaScript power in CSS"}),t("li",{children:["no React built-in-feature -",">"," external library"]}),t("ul",{className:"fragment",children:[t("li",{children:["most popular: ",e("a",{href:"https://styled-components.com/",children:"Styled Components"})," (36K+ stars on GitHub)"]}),t("li",{children:["also used by ",e("a",{href:"https://mui.com/system/styled/",children:"MUI"})]})]})]}),t("aside",{className:"notes",children:["hint: when working with MUI you should checkout the latest version of styling, `the system`, which implements"," ",e("a",{href:"https://tailwindcss.com/",children:"tailwind"})," and makes your styling life a lot easier and esp. faster"]})]}),t(n,{children:[e("h2",{children:"CSS in JS - styled components"}),e(r,{className:"fragment",children:ne}),e(r,{className:"fragment",highlightedLines:"2,7",children:re}),e("pre",{className:"fragment",children:e("a",{style:{fontSize:"1.7rem",marginTop:4},href:"https://github.com/cap-react-trainings/code-examples/blob/02-conditional-rendering-styled-components/react-training-codeexamples/src/components/book/Book.tsx",children:"\u{1F680} code example on GitHub"})})]}),t(n,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Implement a small app which renders a list of books (start in App.tsx)."}),e("li",{children:"There should be a Book-Component which accepts a property of type 'Book'."}),t("li",{children:["Find some sample data"," ",e("a",{href:"https://github.com/cap-react-trainings/code-examples/blob/02-conditional-rendering-styled-components/react-training-codeexamples/src/testData/Booklist.ts",target:"_blank",rel:"noreferrer",children:"here"})]}),e("li",{children:"Choose one styling-method you've just learned about and style your BookList."})]})]})]})),ae=`  interface Props {
...
}`,pe=o=>t(d,c(l({},o),{subtitle:t("ul",{children:[e("li",{children:"rendering different components"}),e("li",{children:"inline conditions"})]}),children:[t(n,{children:[e("h2",{children:"Component uses different return statements"}),e(r,{className:"fragment",children:ae})]}),t(n,{children:[e("h2",{children:"Conditionally assign component to variable"}),t("div",{className:"fragment",children:[e(r,{className:"",children:le}),e(r,{className:"",children:ce})]}),e(r,{className:"fragment",children:de})]}),t(n,{children:[e("h2",{children:"Inline Logic - variant 1"}),e(r,{className:"fragment",children:he})]}),t(n,{children:[e("h2",{children:"Inline Logic - variant 2"}),e(r,{className:"fragment",children:me})]}),t(n,{children:[e("h2",{children:"Prevent component from rendering"}),e(r,{className:"fragment",children:ue})]}),t(n,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),t("ul",{children:[e("li",{children:"Extend your Book-Component with a badge that notifies the user when a book is not available in store. (Your Book-Type might need an additional property)."}),e("li",{children:"Bear in mind that there might be a case where no books are available for rendering. Create a UI for that."})]})]})]})),ge=`// fetch user...
...
`,Ee=o=>t(d,c(l({},o),{children:[t(n,{children:[t("p",{children:["More of a personal preference,",e("br",{}),"but there are a few popular libs:"]}),t("ul",{className:"fragment",children:[e("li",{children:e("a",{href:"https://github.com/jaredpalmer/formik",children:"Formik"})}),e("li",{children:e("a",{href:"https://github.com/react-hook-form/react-hook-form",children:"React Hook Form"})})]}),e("aside",{className:"notes",children:"Depends on personal preference, used UI libs/frameworks and performance requirements."})]}),e(n,{children:t("div",{children:["Components based",e(r,{children:Me})]})}),t(n,{children:[t("div",{children:["Hooks based",e(r,{children:Pe})]}),e("aside",{className:"notes",children:"Better performance wise. Just updates necessary children."})]}),t(n,{children:[e("h2",{children:"Further Reads"}),e("ul",{children:e("li",{children:e("a",{href:"https://dev.to/pmbanugo/looking-for-the-best-react-form-library-in-2021-it-s-probably-on-this-list-e2h",children:"\u{1F4C4} Comparison of four form libraries"})})}),e("aside",{className:"notes",children:"Recommend Kent C. Dotts blog posts. You won't need redux anymore!"})]}),e(n,{children:e("h2",{children:"\u{1F4AA} Exercise"})})]})),De="const element = <h1>Welcome to React!</h1>",Ue=`export default MyButton: React.FC = () => {
...
`,it=o=>t(d,c(l({},o),{children:[t(n,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(n,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(n,{children:[e("h2",{children:"Example"}),e(r,{className:"fragment",children:tt})]}),t(n,{children:[e("h2",{children:"Helper functions"}),e(r,{className:"fragment",children:nt})]}),t(n,{children:[e("h2",{children:"API Mocking with MSW"}),e(r,{className:"fragment",children:rt}),e(r,{className:"fragment",children:ot})]}),t(n,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",children:"React Testing Library"})})]})]}),e(n,{children:e("h2",{children:"\u{1F4AA} Exercise"})})]}));const st={plugins:[S],slideNumber:!0,history:!0},at=o=>(p.exports.useEffect(()=>{new C(st).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),lt=()=>{const o=[{title:"Comparison of Frameworks",component:G},{title:"JSX & TSX",component:je},{title:"Components & Styling",component:se},{title:"Conditional Rendering",component:pe},{title:"Hooks & Databinding",component:He},{title:"Context",component:we},{title:"Routing",component:O},{title:"Forms",component:Ee},{title:"Testing",component:it},{title:"Atomic Design & Storybook",component:et},{title:"Improving Performance",component:Ke},{title:"React Native",component:_e}];return t(at,{children:[e(j,{}),e(z,{chapter:o}),o.map((i,s)=>e(i.component,{title:i.title,index:s+1},s))]})};B.render(e(A.StrictMode,{children:e(lt,{})}),document.getElementById("root"));
