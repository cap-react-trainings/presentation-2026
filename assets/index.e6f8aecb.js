...
`,De="const { loading, books } = useBooks();",Oe=`const fetchUsers = async () => {
...
`,Rt="yarn add -D @testing-library/react @testing-library/jest-dom jest jest-environment-jsdom",St="yarn add -D ts-jest @types/jest @types/testing-library__react @types/testing-library__jest-dom",Bt=`//jest.config.js
...
...`,Ft=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{className:"fragment",children:kt})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{className:"fragment",children:vt})]}),t(r,{children:[e("h2",{children:"API Mocking"}),e(n,{className:"fragment",children:wt})]}),e(r,{children:e(n,{className:"fragment",children:Nt})}),t(r,{children:[e("h2",{children:"Simulate actions"}),e(n,{className:"fragment",children:xt})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})}),e("li",{children:e("a",{href:"https://jestjs.io/docs/jest-object",target:"_blank",rel:"noreferrer",children:"Jest object"})})]})]}),e(r,{children:t("h2",{children:[e("a",{href:"https://jestjs.io/docs/jest-object",target:"_blank",rel:"noreferrer",children:"Jest object"}),e(n,{className:"fragment",children:Ct})]})}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("code",{children:"git checkout 06-forms-chapter"}),e("p",{children:"Setup for testing"}),e(n,{language:"bash",children:Rt}),e(n,{language:"bash",children:St})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("p",{children:"Create / modify files"}),e(n,{language:"bash",children:Bt}),e(n,{language:"bash",children:At})]}),t(r,{children:[t("div",{style:{display:"flex",justifyContent:"center",gap:24},children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("small",{children:"\u23F1\uFE0F 55min"})]}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const k=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const Pt={plugins:[A],slideNumber:!0,history:!0},Tt=o=>(p.exports.useEffect(()=>{new B(Pt).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),Mt=()=>{const o=[{title:"Comparison of Frameworks",component:K},{title:"React in a nutshell \u{1F95C}",component:rt},{title:"Components & Styling",component:be},{title:"Conditional Rendering",component:Se},{title:"Hooks & Databinding",component:We},{title:"Context",component:Me},{title:"Routing",component:V},{title:"Forms",component:Ge},{title:"Testing",component:Ft},{title:"Atomic Design & Storybook",component:bt},{title:"Improving Performance",component:mt},{title:"React Native",component:ft}];return t(Tt,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(k,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(k,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),e(q,{chapter:o}),o.map((i,a)=>e(i.component,{title:i.title,index:a+1},a)),t(r,{isMain:!0,children:[e("h2",{children:"Thanks a lot!"}),e("p",{children:"Please fill out our survey, so that we can keep on improving! \u{1F60A}"})]})]})};F.render(e(P.StrictMode,{children:e(Mt,{})}),document.getElementById("root"));
