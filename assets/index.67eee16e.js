...
const Book = ({ name, author }: BookProps) => {
...
};`,ne=`const Book = ({name="Tom", author="Rowling"}: BookProps) => {
  return (
    <div>
      <h1>{name}</h1>
      <p>author: {author}</p>
  ...
  props.title = "HI"
};`,ie=`const Book = ({ name, author }: BookProps) => {
  return (
    <div>
...
<MyButton title='Hit me' /> // ok`,he="$ npx create-react-app my-app --template typescript",ue="$ npm create vite@latest my-app -- --template react-ts",me="type PropsWithChildren<P> = P & { children?: ReactNode };",pe=`import { PropsWithChildren } from 'react';
...
};`,ge=`interface ChildComponentProps {
...
export default ChildComponent;`,fe=`const ParentComponent = () => {
...
`,ke=`export default LoginButton = () => {
    return <button>Login</button>
}`,ve=`export default LogoutButton = () => {
    return <button>Logout</button>
}`,we=`const AuthenticationComponent = (props: Props) => {
  let button;
  if (props.userName) {
    button = <LogoutButton />
  } else {
...
}`,Ce=o=>t(d,c(l({},o),{subtitle:t("ul",{children:[e("li",{children:"rendering different components"}),e("li",{children:"inline conditions"})]}),children:[t(r,{children:[e("h2",{children:"Component uses different return statements"}),e(n,{className:"fragment",children:be})]}),t(r,{children:[e("h2",{children:"Conditionally assign component to variable"}),t("div",{className:"fragment",children:[e(n,{className:"",children:ke}),e(n,{className:"",children:ve})]}),e(n,{className:"fragment",children:we})]}),t(r,{children:[e("h2",{children:"Inline Logic - variant 1"}),e(n,{className:"fragment",children:Re})]}),t(r,{children:[e("h2",{children:"Inline Logic - variant 2"}),e(n,{className:"fragment",children:Ne})]}),t(r,{children:[e("h2",{children:"Prevent component from rendering"}),e(n,{className:"fragment",children:xe})]}),t(r,{children:[t("div",{style:{display:"flex",justifyContent:"center",gap:24},children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("small",{children:"\u23F1\uFE0F 35min"})]}),t("ul",{children:[e("li",{children:"Extend your Book-Component with a badge that notifies the user when a book is not available in store. (Pass an additional prop to your Book-Component)."}),e("li",{children:"Bear in mind that there might be a case where no books are available for rendering. Create a UI for that."})]})]})]})),Se=`// fetch user...
...
`,Ae=`const user = useContext(UserContext);

<Link href={user.permalink}>
  <Avatar user={user} />
</Link>
`,Fe=`export const ThemeContext = React.createContext({
  theme: themes.dark,
  toggleTheme: () => {},
});
`,Pe=`const {theme, toggleTheme} = useContext(UserContext)
...
`,Ee=`const [currentBooks, setCurrentBooks] = useState<Book[]>();
...
`,Ie="const { loading, books } = useBooks();",De=`const fetchUsers = async () => {
  const res = await fetch("https://jsonplaceholder.typicode.com/users");
  return res.json();
};
`,Oe=`import { useQuery } from "react-query";
...
remove,
status,
`,Ue=`const {isLoading, data, error} = useQuery("books", fetchBooks);
...
npm install
npm start
`,Xe="const element = <h1>Welcome to React!</h1>",Ke=`export default MyButton = () => {
    return <button>Click Me!</button>
}`,Ze=`import MyButton from './myButton';
<MyButton /> // ok
...
`,et=`const element = {
  ...
  `,tt=o=>t(d,c(l({},o),{subtitle:e("p",{children:"Minimal App, Bootstrapping & Templating"}),children:[t(r,{children:[e("h2",{children:"Minimal App"}),e(n,{className:"fragment",children:Ge})]}),t(r,{children:[e("h2",{children:"Bootstrapping a Project"}),e(n,{className:"fragment",language:"bash",children:$e})]}),t(r,{children:[e("h2",{children:"Templating with JSX / TSX"}),e("p",{className:"fragment",children:"syntax extension to JavaScript"}),e("p",{className:"fragment",children:"describe what the UI looks like"}),e("p",{className:"fragment",children:"full power of JavaScript"}),e("p",{className:"fragment",children:"produces React elements"}),e("p",{className:"fragment",children:"TSX enhances JSX in terms of type checking"}),e(n,{className:"fragment",children:Xe})]}),t(r,{children:[e("h2",{children:"JSX / TSX Elements"}),t("ul",{className:"fragment",children:[e("li",{children:"elements are looked up by identifiers"}),e("li",{children:"naming convention starts with capital letter"}),e("li",{children:"You can import them as a component in your app"})]}),e(n,{className:"fragment",children:Ke}),e(n,{className:"fragment",children:Ze})]}),t(r,{children:[e("h2",{children:"JavaScript in Elements"}),e(n,{children:et}),e("p",{children:"notice the following:"}),t("ul",{children:[t("li",{children:["JSX Elements can have mutlitple children but need ",e("b",{children:"one"})," root element"]}),t("li",{children:["empty tags may be closed immediatly with `","/>","`"]}),t("li",{children:["JavaScript can be used inside JSX (","{}",")"]})]})]}),t(r,{children:[e("h2",{children:"Minimal App with data"}),e(n,{children:Ye})]})]})),rt="<AddButton onClick={() => setIsAddOpen(true)} />",nt=`const moizedOpen = useCallback(() => {
    setIsAddOpen(true);
}, []);`,ot=`export const AddButton = React.memo(
...
}, (p1, p2) => p1.books.length === p2.books.length);`,at=`const [books, setBooks] = useState(props.books);
const moizedBook = useMemo(() => {
  return books.find(book => book.author === props.author);
}, [books, props.author]);
`,st=`const AddModal = lazy(() => import('./AddModal))
...
`,lt=`const About = React.lazy(() => import("./pages/About"));
...
`,pt=`const Stack = createNativeStackNavigator();
...
`,wt=`test("Fetches and displays books", async () => {
  await act(() => {
    render(<BookList />);
  }); 
  await waitFor(() => expect(screen.getByText("Snowflake: The Definitive Guide")).toBeInTheDocument());
});
`,Rt=`const handleClick = jest.fn()
render(<Button onClick={handleClick}>Click Me</Button>)
fireEvent.click(screen.getByText(/click me/i))
expect(handleClick).toHaveBeenCalledTimes(1)
`,Nt=`const user = { name: "John", age: 25 };

test('user has correct properties', () => {
  expect(user).toEqual({ name: "John", age: 25 });
  expect(user).toHaveProperty('name', "John");
});
`,xt="yarn add -D @testing-library/react @testing-library/jest-dom jest jest-environment-jsdom",Ct="yarn add -D ts-jest @types/jest @types/testing-library__react @types/testing-library__jest-dom",St=`//jest.config.js
...
...`,At=o=>t(d,c(l({},o),{children:[t(r,{children:[e("h2",{children:"Ways of testing"}),t("ul",{children:[e("li",{className:"fragment",children:"Unit Tests"}),e("li",{className:"fragment",children:"e2e Tests (Running the complete app)"}),e("li",{className:"fragment",children:"Component Tests (Rendering components)"})]}),e("aside",{className:"notes",children:"We only want to look at rendering & testing the components, since unit and e2e tests are not react specific."})]}),t(r,{children:[e("h2",{children:"React Testing Library"}),t("p",{children:["A set of helpers to test React ",e("strong",{children:"components"}),", without relying on implementation details."]})]}),t(r,{children:[e("h2",{children:"Example"}),e(n,{className:"fragment",children:bt})]}),t(r,{children:[e("h2",{children:"Helper functions"}),e(n,{className:"fragment",children:kt})]}),t(r,{children:[e("h2",{children:"API Mocking"}),e(n,{className:"fragment",children:vt})]}),e(r,{children:e(n,{className:"fragment",children:wt})}),t(r,{children:[e("h2",{children:"Simulate actions"}),e(n,{className:"fragment",children:Rt})]}),t(r,{children:[e("h2",{children:"Further Reads"}),t("ul",{children:[e("li",{children:e("a",{href:"https://reactjs.org/docs/testing.html",target:"_blank",rel:"noreferrer",children:"React Docs"})}),e("li",{children:e("a",{href:"https://testing-library.com/docs/react-testing-library/intro",target:"_blank",rel:"noreferrer",children:"React Testing Library"})}),e("li",{children:e("a",{href:"https://jestjs.io/docs/jest-object",target:"_blank",rel:"noreferrer",children:"Jest object"})})]})]}),e(r,{children:t("h2",{children:[e("a",{href:"https://jestjs.io/docs/jest-object",target:"_blank",rel:"noreferrer",children:"Jest object"}),e(n,{className:"fragment",children:Nt})]})}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("code",{children:"git checkout 06-forms-chapter"}),e("p",{children:"Setup for testing"}),e(n,{language:"bash",children:xt}),e(n,{language:"bash",children:Ct})]}),t(r,{children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("p",{children:"Create / modify files"}),e(n,{language:"bash",children:St}),e(n,{language:"bash",children:Bt})]}),t(r,{children:[t("div",{style:{display:"flex",justifyContent:"center",gap:24},children:[e("h2",{children:"\u{1F4AA} Exercise"}),e("small",{children:"\u23F1\uFE0F 55min"})]}),t("ul",{children:[e("li",{children:"Implement test that verifies isCheap-badge logic"}),t("ul",{children:[e("li",{children:'show "cheap" on price < 30'}),e("li",{children:'show "expensive" on price > 30'})]}),e("li",{children:"If you're done, feel free to implement further tests."})]})]})]}));const y=({scale:o=1})=>t("div",{className:"app","data-id":"logo",style:{transform:"scale("+o+")"},children:[e("div",{className:"react"}),e("div",{className:"dot"})]});const Ft={plugins:[S],slideNumber:!0,history:!0},Pt=o=>(p.exports.useEffect(()=>{new C(Ft).initialize()},[]),e("div",{className:"reveal",children:e("div",{className:"slides",children:o.children})})),Tt=()=>{const o=[{title:"Comparison of Frameworks",component:X},{title:"React in a nutshell \u{1F95C}",component:tt},{title:"Components & Styling",component:ye},{title:"Conditional Rendering",component:Ce},{title:"Hooks & Databinding",component:We},{title:"Context",component:Te},{title:"Routing",component:z},{title:"Forms",component:Qe},{title:"Testing",component:At},{title:"Atomic Design & Storybook",component:yt},{title:"Improving Performance",component:ut},{title:"React Native",component:gt}];return t(Pt,{children:[e(r,{isMain:!0,dataAutoAnimate:!0,children:e(y,{scale:2})}),t(r,{isMain:!0,"data-auto-animate":!0,dataAutoAnimate:!0,children:[e("h2",{children:"React Training"}),e("div",{style:{marginTop:50},children:e(y,{})})]}),t(r,{isMain:!0,children:[e("h2",{children:"Why we are here"}),e("p",{children:"React: A JavaScript library for building user interfaces"}),t("p",{children:["\u{1F5A5} ",e("a",{href:"https://reactjs.org/",children:"https://reactjs.org"})]}),e("aside",{className:"notes",children:"Heavily used in the industry. Makes it painless to create interactive UIs. React = `it reacts to user inputs``"})]}),e(V,{chapter:o}),o.map((i,a)=>e(i.component,{title:i.title,index:a+1},a)),t(r,{isMain:!0,children:[e("h2",{children:"Thanks a lot!"}),e("p",{children:"Please fill out our survey, so that we can keep on improving! \u{1F60A}"})]})]})};B.render(e(A.StrictMode,{children:e(Tt,{})}),document.getElementById("root"));
